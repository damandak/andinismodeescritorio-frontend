<template>
  <table class="adetable adetable-general">
    <tbody>
      ...
      <tr v-if="firstAbsoluteTeam.length > 0">
        <th>
          Primer Ascenso
          <span v-if="unregisteredNonSportAscent === true">Deportivo*</span>
        </th>
        <td class="smaller" v-if="firstAbsolute">
          ...
          <NuxtLink
            v-for="(andinist, index) in firstAbsoluteTeam"
      ...
      <tr v-else>
        ...
        <td class="smaller" v-if="unregisteredNonSportAscent === true">
          Ascenso no deportivo
        </td>
        <td class="smaller" v-else>No registrado</td>
      </tr>
    </tbody>
  </table>
</template>
